...
VSM <- read.csv("G:/Shared drives/UGS_Groundwater/Projects/WRI/Tintic/Soil Moisture/RExports//T2Mud1DailyAveVSM.csv")
...
ggplot(daily, aes(x = Day)) +
  ...
  labs(title = "T2 Mud 1", x = "Date", y = "Average Soil Moisture m3/m3 VWC") +
