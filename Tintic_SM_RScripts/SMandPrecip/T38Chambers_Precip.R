...
VSM <- read.csv("G:/Shared drives/UGS_Groundwater/Projects/WRI/Tintic/Soil Moisture/RExports//T38ChambersDailyAveVSM.csv")
...
ggplot(daily, aes(x = Day)) +
  ...
  labs(title = "T38 Chambers", x = "Date", y = "Average Soil Moisture m3/m3 VWC") +
  scale_color_discrete(breaks = c("Port_1", "Port_2", "Precipitation"), 
                       labels = c("1 ft", "3 ft", "Precipitation"),
                       name = "") +
