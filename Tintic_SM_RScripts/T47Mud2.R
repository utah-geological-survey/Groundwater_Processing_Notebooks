...
setwd("G:/Shared drives/UGS_Groundwater/Projects/WRI/Tintic/Soil Moisture/T47 Mud 2/RawData")
...
ggplot(SM_df_tidy2, aes(DateTime, VSM)) +
  ...
  labs(title = "T47 Mud 2", x = "Date", y = "Soil Moisture m3/m3 VWC") +
  ylim(0, 0.6) +
...
write.csv(Daily_VSM, "G:/Shared drives/UGS_Groundwater/Projects/WRI/Tintic/Soil Moisture/RExports//T47Mud2DailyAveVSM.csv")
...
ggplot(Monthly_Mean, aes(Month_Yr, mean_VSM)) +
  ...
  labs(title = "T47 Mud 2 Monthly Average", x = "Month", y = "Average VSM (m3/m3)") +
  scale_color_discrete(breaks = c("Port_1")) +
