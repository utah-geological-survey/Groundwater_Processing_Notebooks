...
setwd("G:/Shared drives/UGS_Groundwater/Projects/WRI/Tintic/Soil Moisture/T43 North Death Creek/RawData")
...
ggplot(SM_df_tidy2, aes(DateTime, VSM)) +
  ...
  labs(title = "T43 North Death Creek", x = "Date", y = "Soil Moisture m3/m3 VWC") +
  ylim(0, 0.6) +
  scale_color_discrete(breaks = c("Port_1", "Port_2", "Port_3"), labels = c("1.5 ft", "4.5 ft", "10 ft"), name = "Sensor Depth")
...
write.csv(Daily_VSM, "G:/Shared drives/UGS_Groundwater/Projects/WRI/Tintic/Soil Moisture/RExports//T43NorthDeathDailyAveVSM.csv")
...
ggplot(Monthly_Mean, aes(Month_Yr, mean_VSM)) +
  ...
  labs(title = "T43 North Death Creek Monthly Average", x = "Month", y = "Average VSM (m3/m3)") +
  scale_color_discrete(breaks = c("Port_1", "Port_2", "Port_3")) +
